				       ...
				       bool defer_texture_update, bool duplicate_hotkeys)
{
	...
	/* Relative scene-item transforms are resolved against scale_ref.  Without
	 * copying it, a duplicated scene created from an imported collection can
	 * render every item at the destination canvas reference size (for example
	 * 1.0 instead of 0.75 when importing 2560x1440 into 1920x1080). */
