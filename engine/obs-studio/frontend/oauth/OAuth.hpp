...
protected:
	...
	bool GetTokenPKCE(const char *url, const std::string &client_id, const std::string &redirect_uri,
			  int scope_ver, const std::string &auth_code, const std::string &code_verifier, bool retry);
	bool GetTokenPKCE(const char *url, const std::string &client_id, const std::string &secret,
